...
from gse.users.models import User, UserProfile
from gse.users.views import UsersListAPI
...
class TestUserRegisterVerificationAPI(APITestCase):
    ...
    @patch('gse.users.views.JWT_token.get_object_or_404')
...
class TestResendVerificationEmailAPI(APITestCase):
    ...
    @patch('gse.utils.send_email.send_link')
...
class TestUserProfileAPI(APITestCase):
    ...
    @patch('gse.users.views.send_verification_email.delay_on_commit')
    ...
    @patch('gse.users.views.Bucket.delete_object')
