...
urlpatterns = [
    ...
    path('questions/<int:question_id>/', views.QuestionRetrieveAPI.as_view(), name='question_retrieve'),
    path('<int:product_id>/questions/add/', views.QuestionCreateAPI.as_view(), name='question_create'),
    path('questions/<int:question_id>/delete/', views.QuestionDeleteAPI.as_view(), name='question_delete'),
